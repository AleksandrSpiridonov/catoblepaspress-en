...
test("English interviews index links only to translated interview routes", () => {
  ...
  assert.match(medvedev, /<video controls playsinline preload="metadata"/)
  assert.match(medvedev, /media\.catoblepaspress\.ru\/journal\/issue-07\/ru\/page-03\.mp4/)
  assert.doesNotMatch(medvedev, /<iframe|t\.me\/catoblepaspress\/175/)
  ...
  assert.match(navka, /<video controls playsinline preload="metadata"/)
  assert.match(navka, /media\.catoblepaspress\.ru\/journal\/issue-09\/ru\/page-05\.mp4/)
  assert.doesNotMatch(navka, /<iframe|t\.me\/catoblepaspress\/247/)
